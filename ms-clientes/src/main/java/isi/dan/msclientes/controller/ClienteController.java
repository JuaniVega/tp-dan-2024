...
public class ClienteController {
    ...
    @PutMapping("/usuario-habilitado/{id}")
    @LogExecutionTime
    ...
    public ResponseEntity<Boolean> verificarSaldoSuficiente(@PathVariable Integer id, @RequestParam BigDecimal total) throws ClienteNotFoundException {
        return ResponseEntity.ok(clienteService.verificarSaldo(id, total));
    }
}
